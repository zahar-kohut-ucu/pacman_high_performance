...
import node2 as node2


def drawTile(screen: pygame.Surface, tile: node2.Node, tileSize: int = 20):
    team = tile.getTeam()
...
def initBoard(maze: maze2.Maze, screen: pygame.Surface, width: int, height: int, tileSize: int = 20):
    screen.fill((0, 0, 0))
...
def redrawBoard(screen: pygame.Surface, maze: maze2.Maze, pacmans, ghosts, coordsOld: list[int], tileSize=20):
